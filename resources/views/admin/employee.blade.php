...
<style>
    ...
    .modal-table thead th { background:#f8fafc; padding:12px 18px; font-size:0.68rem; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.06em; position:sticky; top:0; z-index:5; border-bottom:2px solid #e2e8f0; white-space:normal; vertical-align: middle; }
    ...
    .modal-table th:nth-child(1), .modal-table td:nth-child(1) { width: 10%; } /* Position */
    .modal-table th:nth-child(2), .modal-table td:nth-child(2) { width: 10%; } /* School */
    ...
    .modal-table th:nth-child(9), .modal-table td:nth-child(9) { width: 7%; }  /* Actions */
    ...
    @media (max-width: 1024px) {
        .employees-grid.list-view .card-details { gap: 16px; }
        .employees-grid.list-view .detail-row { min-width: 120px; }
    }

    @media (max-width: 768px) {
        .content-body { padding: 12px 14px !important; }

        .hero-banner { flex-direction: column; border-radius: 12px; }
        .hero-left { padding: 24px 20px; }
        .hero-title { font-size: 1.35rem; }
        .hero-right { width: 100%; border-left: none; border-top: 1.5px solid #e0e7ff; padding: 24px 20px; }
        
        .employees-grid { grid-template-columns: 1fr; gap: 12px; }
        ...
        .employees-grid.list-view { grid-template-columns: 1fr !important; }
        .employees-grid.list-view .employee-card { 
        ...
        .employees-grid.list-view .card-avatar-container { margin: 0 !important; flex-shrink: 0 !important; }
        .employees-grid.list-view .card-avatar { width: 44px !important; height: 44px !important; border-radius: 12px !important; }
        .employees-grid.list-view .card-main { 
        ...
        .employees-grid.list-view .detail-row { min-width: 0 !important; font-size: 0.68rem !important; }
        .employees-grid.list-view .detail-row svg { width: 12px !important; height: 12px !important; }
        .employees-grid.list-view .card-action-bar {
        ...
        .employees-grid.list-view .action-label { display: none !important; }
        .employees-grid.list-view .action-icon { width: 24px !important; height: 24px !important; border-radius: 8px !important; background: #f1f5f9 !important; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.editRecord = function(id) {
        const url = "{{ url('/admin/form') }}?edit=" + id + "&source=employee&employeeName=" + encodeURIComponent(currentEmployeeForModal);
    ...
    window.fetchEmployeeRecords = fetchEmployeeRecords;
});
</script>
