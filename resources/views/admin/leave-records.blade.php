                        ...
                        <tr class="forwarded-header-row" data-forwarded="${forwarded}" data-batch="${batchId}" data-incharge="${r.incharge || ''}">
                            ...
                            <td colspan="${isExportMode ? '11' : '11'}">
                                <div class="forwarded-header-content">
                                    ...
                                    <a href="/admin/form?forwarded=${encodeURIComponent(forwarded)}&batch=${batchId}&source=leave-records" class="btn-add-forwarded-record">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
...
function editRecord(id) {
    window.location.href = "{{ url('/admin/form') }}?edit=" + id + "&source=leave-records";
}
