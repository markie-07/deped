        ...
        <div class="content-body">
            ...
            <div class="accounts-table-card">
                ...
                <div class="table-tabs">
                    <button class="table-tab active" data-role="user" onclick="setRoleFilter('user')">Standard
                        Users</button>
                    <button class="table-tab" data-role="admin" onclick="setRoleFilter('admin')">Administrators</button>
                    <button class="table-tab" data-role="pending" onclick="setRoleFilter('pending')"
                        style="position:relative;">
                        Pending Approval
                        <span id="pendingDot"
                            style="display:none; position:absolute; top:-2px; right:-2px; width:8px; height:8px; background:#ef4444; border-radius:50%; border:2px solid var(--card-bg, #fff);"></span>
                    </button>
                </div>
                <div class="table-wrap">
                    <table class="accounts-table">
                        ...
                        <tbody id="accountsTableBody">
                            <tr>
                                <td colspan="7" class="table-loading">Loading accounts...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-layout">
                ...
                <div class="modal-left">
                    <div class="modal-left-content">
                        <div class="profile-upload" id="profileUploadArea"
                            onclick="document.getElementById('inputProfileImage').click()">
                        ...
                        <div class="modal-left-icon-row">
                            <div class="modal-card-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div class="modal-right">
                    <div class="modal-card-body">
                        ...
                        <div class="form-row">
                            <div class="form-field"><label class="form-label">Last Name <span
                                        class="req">*</span></label>
                                <div class="form-input-wrap"><input type="text" id="inputLastName"
                                        placeholder="Dela Cruz"></div>
                            </div>
                            <div class="form-field"><label class="form-label">First Name <span
                                        class="req">*</span></label>
                                <div class="form-input-wrap"><input type="text" id="inputFirstName" placeholder="Juan">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-field"><label class="form-label">Middle Name</label>
                                <div class="form-input-wrap"><input type="text" id="inputMiddleName"
                                        placeholder="Santos"></div>
                            </div>
                            <div class="form-field"><label class="form-label">Suffix</label>
                                <div class="form-input-wrap"><input type="text" id="inputSuffix" placeholder="Jr., III">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-field"><label class="form-label">Position</label>
                                <div class="form-input-wrap"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    </svg><input type="text" id="inputPosition"
                                        placeholder="e.g. Administrative Officer"></div>
                            </div>
                            <div class="form-field"><label class="form-label">System Role <span
                                        class="req">*</span></label>
                                <div class="form-input-wrap"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="form-row">
                            <div class="form-field" id="statusFieldArea"><label class="form-label">Account Status <span
                                        class="req">*</span></label>
                                <div class="form-input-wrap"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg><select id="inputStatus"
                                        style="flex:1;border:none;outline:none;background:transparent;padding:11px 0;font-size:0.82rem;font-family:inherit;color:#1e293b;">
                                        <option value="1">Active</option>
                                        <option value="0">Inactive</option>
                                    </select></div>
                            </div>
                            <div class="form-field" id="approvalFieldArea"><label class="form-label">Approval Status
                                    <span class="req">*</span></label>
                                <div class="form-input-wrap"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg><select id="inputApproved"
                                        style="flex:1;border:none;outline:none;background:transparent;padding:11px 0;font-size:0.82rem;font-family:inherit;color:#1e293b;">
                        ...
                        <div class="form-row">
                            <div class="form-field"><label class="form-label">Assign <span class="req">*</span></label>
                                <div class="form-input-wrap"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    </svg><select id="inputAssigned"
                                        style="flex:1;border:none;outline:none;background:transparent;padding:11px 0;font-size:0.82rem;font-family:inherit;color:#1e293b;">
                                        <option value="national">National</option>
                                        <option value="city">City</option>
                                    </select></div>
                            </div>
                            <div class="form-field"><label class="form-label">Email Address <span
                                        class="req">*</span></label>
                                <div class="form-input-wrap"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                    </svg><input type="email" id="inputEmail" placeholder="e.g. juan@deped.gov.ph">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <div class="form-input-wrap">
                                    ...
                                    <button type="button" class="pw-toggle-btn"
                                        onclick="toggleModalPassword('inputPassword', this)" title="Show password">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="eye-open">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="eye-closed"
                                            style="display:none;">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="form-field">
                                <label class="form-label" id="confirmLabel">Confirm Password <span
                                        class="req">*</span></label>
                                <div class="form-input-wrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor">
                                    ...
                                    <button type="button" class="pw-toggle-btn"
                                        onclick="toggleModalPassword('inputConfirmPassword', this)"
                                        title="Show password">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="eye-open">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="modal-card-footer">
                        ...
                        <button class="btn-save" id="btnSave" onclick="saveAccount()"><svg
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
        ...
        .table-search-wrap:focus-within svg {
            color: #6366f1;
        }
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
        ...
        @media (max-width: 768px) {
            ...
            body.dark-mode .modal-card-footer {
                background: #0f172a !important;
        ...
        body.dark-mode .hero-meta-divider {
            background: #334155;
        }

        body.dark-mode .hmi-num {
            color: #f8fafc;
        }
        ...
        body.dark-mode .hsc-label {
            color: #818cf8;
        }

        body.dark-mode .hsc-hint {
            color: #64748b;
        }
        ...
        body.dark-mode .filter-select-wrap select option {
            background: #1e293b;
            color: #f1f5f9;
        }
        ...
        body.dark-mode .table-search-wrap {
            background: #0f172a;
        }

        body.dark-mode .table-search-wrap input {
            color: #f1f5f9;
        }

        body.dark-mode .table-tabs {
            background: transparent;
            border-bottom-color: #334155;
        }
        ...
        body.dark-mode .table-tab.active {
            color: #818cf8;
        }

        body.dark-mode .table-tab.active::after {
            background: #818cf8;
        }
        ...
        body.dark-mode .accounts-table tbody td {
            border-bottom-color: #334155;
            color: #cbd5e1;
        }

        body.dark-mode .accounts-table tbody tr:hover td {
            background: #1a1f35;
        }
        ...
        body.dark-mode .cell-idx {
            color: #475569;
        }

        body.dark-mode .cell-username,
        body.dark-mode .cell-email {
            color: #94a3b8;
        }

        body.dark-mode .cell-created,
        body.dark-mode .cell-pos {
            color: #64748b;
        }
        ...
        body.dark-mode .form-input-wrap {
            background: #0a0f1e;
            border: 1.5px solid rgba(255, 255, 255, 0.15);
            box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.2);
        }

        body.dark-mode .form-input-wrap:focus-within {
            border-color: #6366f1;
            background: #050812;
            box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.2);
        }

        body.dark-mode .form-input-wrap input {
            color: #f1f5f9;
        }

        body.dark-mode .form-input-wrap input::placeholder {
            color: #334155;
        }

        body.dark-mode .form-input-wrap select {
            color: #f1f5f9 !important;
        }

        body.dark-mode .form-input-wrap select option {
            background: #0a0f1e;
            color: #f1f5f9;
        }
        ...
        body.dark-mode .modal-left-hint {
            color: #64748b;
        }

        body.dark-mode .modal-card-desc {
            color: #64748b;
        }
        ...
        body.dark-mode .profile-upload:hover {
            border-color: #6366f1;
        ...
        body.dark-mode .pw-toggle-btn {
            color: #334155;
        }

        body.dark-mode .pw-toggle-btn:hover {
            color: #818cf8;
        }
        ...
        body.dark-mode .status-badge.role-admin {
            background: rgba(99, 102, 241, 0.15);
            color: #818cf8;
            border-color: rgba(99, 102, 241, 0.2);
        }

        body.dark-mode .status-badge.role-user {
        ...
        body.dark-mode .btn-toggle-inactive {
            background: rgba(16, 185, 129, 0.15);
            color: #34d399;
        }
    </style>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateStats() {
                ...
                const sideDot = document.getElementById('sidebarPendingDot');
                if (sideDot) sideDot.style.display = pending > 0 ? 'block' : 'none';
            }
            ...
            function resetForm() {
                ['editId', 'inputLastName', 'inputFirstName', 'inputMiddleName', 'inputSuffix', 'inputPosition', 'inputEmail', 'inputPassword', 'inputConfirmPassword'].forEach(id => document.getElementById(id).value = '');
                ...
                document.getElementById('inputAssigned').value = 'national';
            ...
            window.editAccountById = function (id) {
                ...
                document.getElementById('inputAssigned').value = acc.assigned || 'national';
            ...
            window.saveAccount = async function () {
                ...
                if (!lastName || !firstName || !email) { errEl.textContent = 'Last name, first name, and email are required.'; errEl.style.display = 'block'; return; }
                ...
                formData.append('assigned', document.getElementById('inputAssigned').value);
