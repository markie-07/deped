...
<div class="sidebar active" id="sidebar">
    ...
    <!-- Profile Section -->
    <a href="/user/profile" class="sidebar-profile" style="text-decoration: none; display: flex; flex-direction: column; align-items: center;">
    ...
    <div class="nav-panels-container">
        ...
        <ul class="nav-list nav-panel" id="mainNavPanel">
            <li class="nav-list-item {{ request()->is('user/dashboard') ? 'active' : '' }}" data-tooltip="Dashboard">
                <b></b><b></b>
            ...
            <li class="nav-list-item {{ request()->is('user/form') ? 'active' : '' }}" data-tooltip="Form">
                <b></b><b></b>
            ...
            <li class="nav-list-item {{ request()->is('user/leave-records') ? 'active' : '' }}" data-tooltip="Leave Records">
                <b></b><b></b>
                <a href="/user/leave-records" class="nav-link">
                    <div class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
        ...
        <ul class="nav-list nav-panel nav-panel-sub" id="leaveHistoryPanel">
            ...
            <li class="nav-list-item {{ request()->is('user/employee') ? 'active' : '' }}" data-tooltip="Employee">
                <b></b><b></b>
                <a href="/user/employee" class="nav-link">
                    <div class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
            ...
            <li class="nav-list-item {{ request()->is('user/school') ? 'active' : '' }}" data-tooltip="School">
                <b></b><b></b>
                <a href="/user/school" class="nav-link">
                    <div class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
            ...
            <li class="nav-list-item {{ request()->is('user/position') ? 'active' : '' }}" data-tooltip="Position">
                <b></b><b></b>
                <a href="/user/position" class="nav-link">
                    <div class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
            ...
            <li class="nav-list-item {{ request()->is('user/types-of-leave') ? 'active' : '' }}" data-tooltip="Types of Leave">
                <b></b><b></b>
                <a href="/user/types-of-leave" class="nav-link">
                    <div class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
            ...
            <li class="nav-list-item {{ request()->is('user/remarks') ? 'active' : '' }}" data-tooltip="Remarks">
                <b></b><b></b>
                <a href="/user/remarks" class="nav-link">
                    <div class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
