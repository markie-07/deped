...
<style>
    ...
    .modal-table thead th { background: #f0fdfb; padding: 12px 18px; font-size: 0.68rem; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.06em; position: sticky; top: 0; z-index: 5; border-bottom: 2px solid #ccfbf1; white-space: normal; vertical-align: middle; }
    ...
    /* Column widths for Types of Leave Modal */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.editRecord = function(id) {
        window.location.href = "{{ url('/user/form') }}?edit=" + id + "&source=types-of-leave&typeName=" + encodeURIComponent(currentTypeForModal);
    };
