                    ...
                    <div class="hero-search-card">
                        ...
                        <div class="hero-filter">
                            <div class="filter-select-wrap">
                                ...
                                <select id="assignedFilter" onchange="fetchPositions()">
            ...
            <div class="modal-panel">
                ...
                <div class="panel-filters">
                    ...
                    <div class="pf-date-wrap">
                        ...
                        <input type="date" id="modalFilterDate" value="{{ date('Y-m-d') }}" onchange="fetchPositionRecords()">
                    </div>
                </div>
...
<style>
    ...
    .filter-select-wrap { position: relative; display: flex; align-items: center; background: #fff; border-radius: 14px; border: 1.5px solid #ddd6fe; padding: 0 14px; box-shadow: 0 4px 16px rgba(99,102,241,0.08); transition: all 0.2s; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchPositions() {
        ...
        const apiPath = assigned === 'all' ? '{{ url("/leave-records/positions") }}' : `{{ url("/leave-records/positions") }}?assigned=${assigned}`;
    ...
    fetchPositions();
    document.getElementById('assignedFilter').addEventListener('change', fetchPositions);
    ...
    window.fetchPositionRecords = function() {
        ...
        let url = `{{ url("/leave-records/by-position") }}?position=${encodeURIComponent(currentPosForModal)}&date=${encodeURIComponent(date)}`;
        if (assigned !== 'all') {
    ...
    window.editRecord = function(id) {
        window.location.href = "{{ url('/user/form') }}?edit=" + id + "&source=position&positionName=" + encodeURIComponent(currentPosForModal);
    };
